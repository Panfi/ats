<?php
/*
*  Template name: Accreditation page
*/
?>
<?php get_header();?>
<body>
		...
		<section id="body" class="width">
			...
			<header>
				...
				<div class="the-page accredt-title">
					<h1>Accreditations</h1>
<!-- 					<h1>SUBTITLE</h1> -->
					<p><?php if (dynamic_sidebar('accredt-block')); ?></p>
<!-- 					<a href="<?php bloginfo('url');?>/contact-us">
						<button class="accredt-btn">
							Contact Us
						</button>
					</a> -->
				</div>
			...
			<section id="content" class="column-right accredt">
